...
/// Reaction data that is (potentially) stored with an IRC message.
...
/// A reaction with context needed to determine how to store the reaction (e.g.
/// whether to potentially send a notification when storing the reaction,
/// whether to deduplicate when storing the reaction, etc).
#[derive(Debug, Clone)]
