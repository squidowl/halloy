...
impl Manager {
    ...
    pub fn update(
        ...
        match message {
            ...
            Message::Highlights(highlights) => {
                ...
                let updates = highlights
                    .into_iter()
                    .map(|message| Update::Message(None, message))
                    .collect();
    ...
    pub fn set_filters(
        ...
        // TODO: Focus history reprocessing to only be performed on servers that
        // have had their filters modified.
    ...
    pub fn reload_channel_monitor(
        &mut self,
        _clients_context: &dyn ClientsContext,
        _channel_monitor_config: &config::ChannelMonitor,
    ) {
        todo!()
    }
}
...
pub struct Storage {
    ...
    // `display_read_marker` is u sed to avoid too many visible updates to the
    ...
    M: message::Searchable,
{
    ...
    match limit {
        ...
        message::Limit::Around(count, history_id) => {
            ...
            {
                let before_count = count / 2;
                let after_count = count - before_count - 1;
