...
impl Manager {
    ...
    pub fn set_filters(
        ...
        // TODO: Restrict history reprocessing to only be performed on servers
        // that have had their filters modified.
                ...
                match update {
                    Update::Message(_, mut message) => {
                                ...
                                message.inner.target.as_channel()
                        {
                            ...
                            post_write_update.highlights.push(Update::Message(
                                None,
                                message::MessageWithContext {
