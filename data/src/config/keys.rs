...
pub struct Keyboard {
    ...
    pub new_horizontal_buffer: KeyBind,
    pub new_vertical_buffer: KeyBind,
...
impl Default for Keyboard {
    fn default() -> Self {
        Self {
            ...
            new_horizontal_buffer: KeyBind::new_horizontal_buffer(),
            new_vertical_buffer: KeyBind::new_vertical_buffer(),
            ...
            quit_application: KeyBind::quit_application(),
        }
    }
}
...
impl Keyboard {
    pub fn shortcuts(&self) -> Vec<Shortcut> {
        ...
        vec![
            ...
            shortcut(self.new_horizontal_buffer.clone(), NewHorizontalBuffer),
            shortcut(self.new_vertical_buffer.clone(), NewVerticalBuffer),
