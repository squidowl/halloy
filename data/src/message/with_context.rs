...
/// An IRC message with context needed to determine how to store the message
/// (e.g. whether to potentially send a notification when storing the message,
/// whether to deduplicate when storing the message, whether to store a copy in
/// the highlights buffer, etc).
#[derive(Debug, Clone)]
