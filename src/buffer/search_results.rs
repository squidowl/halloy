...
use data::{Config, Image, Preview, Server, history, message, preview};
use iced::widget::{
...
pub fn view<'a>(
        ...
        column![
            ...
            row![
                pick_list(
                    ...
                    timestamp_kinds,
                    SearchQueryTimestampKind::to_string
                ),
    ...
    let messages = container(
        scroll_view::view(
            &state.scroll_view,
            scroll_view::Kind::SearchResults(server),
            history,
            None,
            ...
            move |message: &'a data::Message, _, _, _| match &message.target {
                ...
                message::Target::SearchResults {
                    ...
                    let text = message_content(
                        ...
                        move |theme| {
                            theme::font_style::server(theme, source.as_ref())
                        },
                        Option::<fn(Color) -> Color>::None,
                        None,
                        config,
