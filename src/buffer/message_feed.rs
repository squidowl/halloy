...
impl Kind {
    pub(super) fn history_ref(self) -> history::KindRef<'static> {
        match self {
            Self::Highlights => history::KindRef::Highlights,
            Self::ChannelMonitor => history::KindRef::ChannelMonitor,
        }
    }
