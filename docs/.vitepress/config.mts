...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Guides', link: '/guides/flatpaks' },
    ],
    editLink: {
      pattern: 'https://github.com/squidowl/halloy/edit/main/docs/:path',
    },
    socialLinks: [{ icon: 'github', link: 'https://github.com/squidowl/halloy' }],
    sidebar: [
      {
        text: 'Overview',
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Example Server Configurations', link: '/guides/example-server-configurations' },
          { text: 'Inclusion/Exclusion Conditions', link: '/configuration/conditions' },
          ...
          { text: 'Storing Passwords in a File', link: '/guides/password-file' },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              { text: 'Backlog Separator', link: '/configuration/buffer/backlog-separator/' },
              {
                text: 'Channel',
                link: '/configuration/buffer/channel/',
                items: [
                  { text: 'Message', link: '/configuration/buffer/channel/message' },
                  { text: 'Nicklist', link: '/configuration/buffer/channel/nicklist' },
                  { text: 'Typing', link: '/configuration/buffer/channel/typing' },
                  { text: 'Topic Banner', link: '/configuration/buffer/channel/topic-banner' },
                ],
              },
              { text: 'Chat History', link: '/configuration/buffer/chat-history/' },
              {
                text: 'Commands',
                link: '/configuration/buffer/commands/',
                items: [
                  { text: 'Aliases', link: '/configuration/buffer/commands/aliases' },
                  { text: 'Sysinfo', link: '/configuration/buffer/commands/sysinfo' },
                  { text: 'Quit', link: '/configuration/buffer/commands/quit' },
                  { text: 'Part', link: '/configuration/buffer/commands/part' },
                ],
              },
              { text: 'Date Separators', link: '/configuration/buffer/date-separators/' },
              { text: 'Emojis', link: '/configuration/buffer/emojis/' },
              {
                text: 'Internal Messages',
                link: '/configuration/buffer/internal-messages/',
                items: [
                  { text: 'Error', link: '/configuration/buffer/internal-messages/error' },
                  { text: 'Success', link: '/configuration/buffer/internal-messages/success' },
                ],
              },
              { text: 'Mark as Read', link: '/configuration/buffer/mark-as-read/' },
              {
                text: 'Nickname',
                link: '/configuration/buffer/nickname/',
                items: [{ text: 'Hide Consecutive', link: '/configuration/buffer/nickname/hide-consecutive' }],
              },
              {
                text: 'Server Messages',
                link: '/configuration/buffer/server-messages/',
                items: [{ text: 'Condense', link: '/configuration/buffer/server-messages/condense' }],
              },
              { text: 'Status Message Prefix', link: '/configuration/buffer/status-message-prefix/' },
              {
                text: 'Text Input',
                link: '/configuration/buffer/text-input/',
                items: [
                  { text: 'Autocomplete', link: '/configuration/buffer/text-input/autocomplete' },
                  { text: 'Nickname', link: '/configuration/buffer/text-input/nickname' },
                ],
              },
          ...
          { text: 'Check for Update on Launch', link: '/configuration/check-for-update-on-launch' },
          { text: 'Commands', link: '/commands' },
          {
            text: 'Context Menu',
            link: '/configuration/context-menu/',
            items: [{ text: 'Padding', link: '/configuration/context-menu/padding' }],
          },
          { text: 'CTCP', link: '/configuration/cctp/' },
          {
            ...
            items: [
              { text: 'Auto Accept', link: '/configuration/file-transfer/auto_accept' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Windows', link: '/configuration/platform-specific/windows' },
            ],
          },
          {
            text: 'Preview',
          ...
          { text: 'Scale factor', link: '/configuration/scale-factor' },
          {
            ...
            items: [
              ...
              { text: 'SASL External', link: '/configuration/servers/sasl-external' },
              { text: 'SASL Plain', link: '/configuration/servers/sasl-plain' },
              { text: 'Confirm Message Delivery', link: '/configuration/servers/confirm-message-delivery' },
            ],
          },
          {
            text: 'Sidebar',
            ...
            items: [
              ...
              { text: 'Unread Indicator', link: '/configuration/sidebar/unread-indicator' },
