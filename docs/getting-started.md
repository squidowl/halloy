...
Once connected to a server, you can join channels. This can be done automatically from the config file or manually using the join command: `/join #channel`[^1]. To find channels, you can either use the list command: `/list` to open the [channel discovery pane](/guides/internal-buffers), or [browse for channels online](https://netsplit.de/channels/).
