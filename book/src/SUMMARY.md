...
- [Configuration](configuration/README.md)
  - [Buffer](configuration/buffer/README.md)
    ...
    - [Server Messages](configuration/buffer/server_messages/README.md)
      ...
      - [Monitored Online](configuration/buffer/server_messages/monitored_online.md)
      - [Part](configuration/buffer/server_messages/part.md)
      - [Quit](configuration/buffer/server_messages/quit.md)
      - [Standard Reply: Fail](configuration/buffer/server_messages/standard_reply_fail.md)
      - [Standard Reply: Note](configuration/buffer/server_messages/standard_reply_note.md)
      - [Standard Reply: Warn](configuration/buffer/server_messages/standard_reply_warn.md)
